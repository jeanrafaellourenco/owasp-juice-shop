...
1. Após iniciar a aplicação seguindo as instruções em [Readme](README.md), acesse no seu navegador o seguinte endereço: [http://127.0.0.1:3000](http://127.0.0.1:3000).  
